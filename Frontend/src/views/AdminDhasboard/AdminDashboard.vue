...
<!-------sidebar--design- close----------->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Ajouter Assistant</h5>
      ...
      <div class="modal fade" tabindex="-1" id="editEmployeeModal" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
          <h5 class="modal-title">Modifier Assistant</h5>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Supprimer Assistant</h5>
  ...
  export default {
    ...
    methods: {
    getEmployees() {
            fetch(`http://localhost:8080/assistant/all`)
                .then(response => {
                    if (!response.ok) {
    ...
    MethodaddEmployee() {
      fetch('http://localhost:8080/assistant/save', {
                  method: 'POST',
                  headers: {
    ...
    fetch(`http://localhost:8080/assistant/delete/${id}`, {
        method: 'DELETE'
    })
    .then(response => {
        if (!response.ok) {
    ...
    MethodeditEmployee() {
      fetch(`http://localhost:8080/assistant/modif/${this.editEmployeeData.id}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json'
    },
